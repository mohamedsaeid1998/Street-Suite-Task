...
export const FiltrationModel = ({ closeModal, isOpen, filteredItems, setFilteredItems, setFormData, clearAllFilteredItems }: IProps) => {
  ...
  return <>
    <Model  {...{ isOpen, closeModal }}>
      <section className='px-6 py-1 bg-mainBg w-full  '>
        <div className='flex flex-col justify-center w-full '>
          ...
          <form onSubmit={handleSubmit(handleFiltration)}>
            <div className='bg-[#202020] rounded-md mt-3 mb-2 px-8 pt-[10px] pb-[8px]'>
              ...
              <details className='text-white flex'>
                ...
                <div className='flex items-center justify-between '>
                  ...
                  <div className='flex flex-col  py-2 mt-1   w-[60%] '>
                  ...
                  <div className='flex flex-col  py-2 mt-1   mb-auto '>
              ...
              <div className='mt-3 flex items-center justify-between pe-7 '>
                ...
                <div className='flex flex-col items-center ps-2 text-white '>
                  ...
                  <div className='flex flex-col items-center '>
                    ...
                    <div className='mt-1 w-full text-sm bg-gradient-to-t from-black to-white text-transparent bg-clip-text'>
                      ...
                      <label htmlFor="futures"><span className='text-sm'>Futures</span></label>
                    </div>
                  </div>
                </div>
